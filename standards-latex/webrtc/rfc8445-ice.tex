...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{RFC 8445}
\fancyhead[C]{Interactive Connectivity Establishment (ICE): A Protocol for Network Address Translator (NAT) Traversal}
\fancyhead[R]{July 2018}
\fancyfoot[C]{\thepage}
...
\title{Interactive Connectivity Establishment (ICE): A Protocol for Network Address Translator (NAT) Traversal\\[1em]
\large RFC 8445\\
Internet Engineering Task Force (IETF)\\
Category: Standards Track                                   J}

\author{A. Keranen, July 2018}
...
\section{Overview of ICE . . . . . . . . . . . . . . . . . . . . . . .   6}

\subsection{Gathering Candidates  . . . . . . . . . . . . . . . . . .   8}

\subsection{Connectivity Checks . . . . . . . . . . . . . . . . . . .  10}

\subsection{Nominating Candidate Pairs and Concluding ICE . . . . . .  12}

\subsection{ICE Restart . . . . . . . . . . . . . . . . . . . . . . .  13}

\subsection{Lite Implementations  . . . . . . . . . . . . . . . . . .  13}

\section{ICE Usage . . . . . . . . . . . . . . . . . . . . . . . . . .  13}

\section{Terminology . . . . . . . . . . . . . . . . . . . . . . . . .  13}

\section{ICE Candidate Gathering and Exchange  . . . . . . . . . . . .  17}

\subsection{Full Implementation . . . . . . . . . . . . . . . . . . .  17}

\subsubsection{Gathering Candidates  . . . . . . . . . . . . . . . .  18}

\paragraph{Host Candidates . . . . . . . . . . . . . . . . .  18}

\paragraph{Server-Reflexive and Relayed Candidates . . . . .  20}

\paragraph{Computing Foundations . . . . . . . . . . . . . .  21}

\paragraph{Keeping Candidates Alive  . . . . . . . . . . . .  21}

\subsubsection{Prioritizing Candidates . . . . . . . . . . . . . . .  22}

\paragraph{Recommended Formula . . . . . . . . . . . . . . .  22}

\paragraph{Guidelines for Choosing Type and Local}

Preferences . . . . . . . . . . . . . . . . . . .  23

\subsubsection{Eliminating Redundant Candidates  . . . . . . . . . .  23}

\subsection{Lite Implementation Procedures  . . . . . . . . . . . . .  23}

\subsection{Exchanging Candidate Information  . . . . . . . . . . . .  24}

\subsection{ICE Mismatch  . . . . . . . . . . . . . . . . . . . . . .  26}

\section{ICE Candidate Processing  . . . . . . . . . . . . . . . . . .  26}

\subsection{Procedures for Full Implementation  . . . . . . . . . . .  26}

\subsubsection{Determining Role  . . . . . . . . . . . . . . . . . .  26}

\subsubsection{Forming the Checklists  . . . . . . . . . . . . . . .  28}

\paragraph{Checklist State . . . . . . . . . . . . . . . . .  28}

\paragraph{Forming Candidate Pairs . . . . . . . . . . . . .  28}

\paragraph{Computing Pair Priority and Ordering Pairs  . . .  31}

\paragraph{Pruning the Pairs . . . . . . . . . . . . . . . .  31}

\paragraph{Removing Lower-Priority Pairs . . . . . . . . . .  31}

\paragraph{Computing Candidate Pair States . . . . . . . . .  32}

\subsubsection{ICE State . . . . . . . . . . . . . . . . . . . . . .  36}

\subsubsection{Scheduling Checks . . . . . . . . . . . . . . . . . .  36}

\paragraph{Triggered-Check Queue . . . . . . . . . . . . . .  36}

\paragraph{Performing Connectivity Checks  . . . . . . . . .  36}

\subsection{Lite Implementation Procedures  . . . . . . . . . . . . .  38}

\section{Performing Connectivity Checks  . . . . . . . . . . . . . . .  38}

\subsection{STUN Extensions . . . . . . . . . . . . . . . . . . . . .  38}

\subsubsection{PRIORITY  . . . . . . . . . . . . . . . . . . . . . .  38}

\subsubsection{USE-CANDIDATE . . . . . . . . . . . . . . . . . . . .  38}

\subsubsection{ICE-CONTROLLED and ICE-CONTROLLING  . . . . . . . . .  39}

\subsection{STUN Client Procedures  . . . . . . . . . . . . . . . . .  39}

\subsubsection{Creating Permissions for Relayed Candidates . . . . .  39}

\subsubsection{Forming Credentials . . . . . . . . . . . . . . . . .  39}

\subsubsection{Diffserv Treatment  . . . . . . . . . . . . . . . . .  40}

\subsubsection{Sending the Request . . . . . . . . . . . . . . . . .  40}

\subsubsection{Processing the Response . . . . . . . . . . . . . . .  40}

\paragraph{Role Conflict . . . . . . . . . . . . . . . . . .  40}

\paragraph{Failure . . . . . . . . . . . . . . . . . . . . .  41}

7.2.5.2.1.  Non-Symmetric Transport Addresses . . . . . .  41 7.2.5.2.2.  ICMP Error  . . . . . . . . . . . . . . . . .  41 7.2.5.2.3.  Timeout . . . . . . . . . . . . . . . . . . .  41 7.2.5.2.4.  Unrecoverable STUN Response . . . . . . . . .  41

\paragraph{Success . . . . . . . . . . . . . . . . . . . . .  42}

7.2.5.3.1.  Discovering Peer-Reflexive Candidates . . . .  42 7.2.5.3.2.  Constructing a Valid Pair . . . . . . . . . .  43 7.2.5.3.3.  Updating Candidate Pair States  . . . . . . .  44 7.2.5.3.4.  Updating the Nominated Flag . . . . . . . . .  44

\paragraph{Checklist State Updates . . . . . . . . . . . . .  44}

\subsection{STUN Server Procedures  . . . . . . . . . . . . . . . . .  45}

\subsubsection{Additional Procedures for Full Implementations  . . .  45}

\paragraph{Detecting and Repairing Role Conflicts  . . . . .  46}

\paragraph{Computing Mapped Addresses  . . . . . . . . . . .  47}

\paragraph{Learning Peer-Reflexive Candidates  . . . . . . .  47}

\paragraph{Triggered Checks  . . . . . . . . . . . . . . . .  47}

\paragraph{Updating the Nominated Flag . . . . . . . . . . .  49}

\subsubsection{Additional Procedures for Lite Implementations  . . .  49}

\section{Concluding ICE Processing . . . . . . . . . . . . . . . . . .  50}

\subsection{Procedures for Full Implementations . . . . . . . . . . .  50}

\subsubsection{Nominating Pairs  . . . . . . . . . . . . . . . . . .  50}

\subsubsection{Updating Checklist and ICE States . . . . . . . . . .  51}

\subsection{Procedures for Lite Implementations . . . . . . . . . . .  52}

\subsection{Freeing Candidates  . . . . . . . . . . . . . . . . . . .  53}

\subsubsection{Full Implementation Procedures  . . . . . . . . . . .  53}

\subsubsection{Lite Implementation Procedures  . . . . . . . . . . .  53}

\section{ICE Restarts  . . . . . . . . . . . . . . . . . . . . . . . .  53}

10. ICE Option  . . . . . . . . . . . . . . . . . . . . . . . . .  54 11. Keepalives  . . . . . . . . . . . . . . . . . . . . . . . . .  54 12. Data Handling . . . . . . . . . . . . . . . . . . . . . . . .  55

\subsection{Sending Data . . . . . . . . . . . . . . . . . . . . . .  55}

\subsubsection{Procedures for Lite Implementations  . . . . . . . .  56}

\subsection{Receiving Data . . . . . . . . . . . . . . . . . . . . .  56}

13. Extensibility Considerations  . . . . . . . . . . . . . . . .  57 14. Setting Ta and RTO  . . . . . . . . . . . . . . . . . . . . .  57

\subsection{General  . . . . . . . . . . . . . . . . . . . . . . . .  57}
...
\subsection{Example with IPv4 Addresses  . . . . . . . . . . . . . .  60}

\subsection{Example with IPv6 Addresses  . . . . . . . . . . . . . .  65}

16. STUN Extensions . . . . . . . . . . . . . . . . . . . . . . .  69

\subsection{Attributes . . . . . . . . . . . . . . . . . . . . . . .  69}

\subsection{New Error-Response Codes . . . . . . . . . . . . . . . .  70}

17. Operational Considerations  . . . . . . . . . . . . . . . . .  70

\subsection{NAT and Firewall Types . . . . . . . . . . . . . . . . .  70}

\subsection{Bandwidth Requirements . . . . . . . . . . . . . . . . .  70}

\subsubsection{STUN and TURN Server-Capacity Planning . . . . . . .  71}

\subsubsection{Gathering and Connectivity Checks  . . . . . . . . .  71}

\subsubsection{Keepalives . . . . . . . . . . . . . . . . . . . . .  72}

\subsection{ICE and ICE-Lite . . . . . . . . . . . . . . . . . . . .  72}

\subsection{Troubleshooting and Performance Management . . . . . . .  72}

\subsection{Endpoint Configuration . . . . . . . . . . . . . . . . .  73}

18. IAB Considerations  . . . . . . . . . . . . . . . . . . . . .  73

\subsection{Problem Definition . . . . . . . . . . . . . . . . . . .  73}

\subsection{Exit Strategy  . . . . . . . . . . . . . . . . . . . . .  74}

\subsection{Brittleness Introduced by ICE  . . . . . . . . . . . . .  74}

\subsection{Requirements for a Long-Term Solution  . . . . . . . . .  75}

\subsection{Issues with Existing NAPT Boxes  . . . . . . . . . . . .  75}

19. Security Considerations . . . . . . . . . . . . . . . . . . .  76

\subsection{IP Address Privacy . . . . . . . . . . . . . . . . . . .  76}

\subsection{Attacks on Connectivity Checks . . . . . . . . . . . . .  77}

\subsection{Attacks on Server-Reflexive Address Gathering  . . . . .  80}

\subsection{Attacks on Relayed Candidate Gathering . . . . . . . . .  80}

\subsection{Insider Attacks  . . . . . . . . . . . . . . . . . . . .  81}

\subsubsection{STUN Amplification Attack  . . . . . . . . . . . . .  81}

20. IANA Considerations . . . . . . . . . . . . . . . . . . . . .  82

\subsection{STUN Attributes  . . . . . . . . . . . . . . . . . . . .  82}

\subsection{STUN Error Responses . . . . . . . . . . . . . . . . . .  82}

\subsection{ICE Options  . . . . . . . . . . . . . . . . . . . . . .  82}

21. Changes from RFC 5245 . . . . . . . . . . . . . . . . . . . .  83 22. References  . . . . . . . . . . . . . . . . . . . . . . . . .  84

\subsection{Normative References . . . . . . . . . . . . . . . . . .  84}

\subsection{Informative References . . . . . . . . . . . . . . . . .  85}

\section{Lite and Full Implementations  . . . . . . . . . . .  89}

\section{Design Motivations . . . . . . . . . . . . . . . . .  90}

\subsection{Pacing of STUN Transactions . . . . . . . . . . . . . . .  90}

\subsection{Candidates with Multiple Bases  . . . . . . . . . . . . .  92}

\subsection{Purpose of the Related-Address and Related-Port}

Attributes  . . . . . . . . . . . . . . . . . . . . . . .  94

\subsection{Importance of the STUN Username . . . . . . . . . . . . .  95}

\subsection{The Candidate Pair Priority Formula . . . . . . . . . . .  96}

\subsection{Why Are Keepalives Needed?  . . . . . . . . . . . . . . .  96}

\subsection{Why Prefer Peer-Reflexive Candidates? . . . . . . . . . .  97}

\subsection{Why Are Binding Indications Used for Keepalives?  . . . .  97}

\subsection{Selecting Candidate Type Preference . . . . . . . . . . .  97}

\section{Connectivity-Check Bandwidth . . . . . . . . . . . .  99}

Acknowledgements  . . . . . . . . . . . . . . . . . . . . . . . . 100 Authors' Addresses  . . . . . . . . . . . . . . . . . . . . . . . 100
...
\begin{center}
\textbf{Figure 1: ICE Deployment Scenario}
\end{center}
...
\begin{itemize}
\item A transport address on a directly attached network interface
\item A translated transport address on the public side of a NAT (a "server-reflexive" address)
\item A transport address allocated from a TURN server (a "relayed address")
...
\end{itemize}
\subsection{Gathering Candidates}
...
\begin{center}
\textbf{Figure 2: Candidate Relationships}
\end{center}
...
\subsection{Connectivity Checks}
...
\section{Sort the candidate pairs in priority order.}

\section{Send checks on each candidate pair in priority order.}

\section{Acknowledge checks received from the other agent.}
...
\begin{center}
\textbf{Figure 3: Basic Connectivity Check}
\end{center}
...
\subsection{Nominating Candidate Pairs and Concluding ICE}
...
\subsection{Lite Implementations}
...
Nomination:  The process of the controlling agent indicating to the controlled agent which candidate pair the ICE agents will use for sending and receiving data.  The nomination process defined in this specification was referred to as "regular nomination" in RFC

\section{The nomination process that was referred to as "aggressive}
...
\section{ICE Candidate Gathering and Exchange}
...
\subsubsection{Gathering Candidates}
...
\begin{itemize}
\item Addresses from a loopback interface MUST NOT be included in the candidate addresses.
\item Deprecated IPv4-compatible IPv6 addresses [RFC4291] and IPv6 site- local unicast addresses [RFC3879] MUST NOT be included in the address candidates.
\item IPv4-mapped IPv6 addresses SHOULD NOT be included in the address candidates unless the application using ICE does not support IPv4 (i.e., it is an IPv6-only application [RFC4038]).
\item If gathering one or more host candidates that correspond to an IPv6 address that was generated using a mechanism that prevents location tracking [RFC7721], host candidates that correspond to IPv6 addresses that do allow location tracking, are configured on the same interface, and are part of the same network prefix MUST NOT be gathered.  Similarly, when host candidates corresponding to
...
\end{itemize}
\paragraph{Server-Reflexive and Relayed Candidates}
...
\paragraph{Computing Foundations}
...
\begin{itemize}
\item They have the same type (host, relayed, server reflexive, or peer reflexive).
\item Their bases have the same IP address (the ports can be different).
\item For reflexive and relayed candidates, the STUN or TURN servers used to obtain them have the same IP address (the IP address used by the agent to contact the STUN or TURN server).
\item They were obtained using the same transport protocol (TCP, UDP).
...
\end{itemize}
\paragraph{Keeping Candidates Alive}
...
\subsubsection{Prioritizing Candidates}
...
priority = (2\textasciicircum{}24)*(type preference) + (2\textasciicircum{}8)*(local preference) + (2\textasciicircum{}0)*(256 - component ID)
...
\paragraph{Guidelines for Choosing Type and Local Preferences}
...
\subsubsection{Eliminating Redundant Candidates}
...
\subsection{Lite Implementation Procedures}
...
\subsection{Exchanging Candidate Information}
...
\section{ICE Candidate Processing}
...
\subsection{Procedures for Full Implementation}

\subsubsection{Determining Role}
...
\subsubsection{Forming the Checklists}
...
\paragraph{Forming Candidate Pairs}
...
\begin{center}
\textbf{Figure 5: Conceptual Diagram of a Checklist}
\end{center}

\paragraph{Computing Pair Priority and Ordering Pairs}
...
pair priority = 2\textasciicircum{}32*MIN(G,D) + 2*MAX(G,D) + (G>D?1:0)
...
\paragraph{Removing Lower-Priority Pairs}
...
\paragraph{Computing Candidate Pair States}
...
\begin{quote}
\textit{Note: |         |           | | perform |           | Waiting  |-------->|In-Progress| |         |           | |         |           |}
\end{quote}
...
\begin{center}
\textbf{Figure 6: Pair State Finite State Machine (FSM)}
\end{center}

The initial states for each pair in a checklist are computed by performing the following sequence of steps:

\section{The checklists are placed in an ordered list (the order is}

determined by each ICE usage), called the "checklist set".

\section{The ICE agent initially places all candidate pairs in the Frozen}

state.

\section{The agent sets all of the checklists in the checklist set to the}

Running state.

\section{For each foundation, the agent sets the state of exactly one}
...
\section{The agent sets all of the pairs in the checklist set to the}

Frozen state.

f1    f2    f3    f4    f5 ----------------------------- m1 | f-cp  f-cp  f-cp | m2 | f-cp  f-cp  f-cp  f-cp | m3 | f-cp                    f-cp

\section{For each foundation, the candidate pair with the lowest}

component ID is placed in the Waiting state, unless a candidate pair associated with the same foundation has already been put in the Waiting state in one of the other examined checklists in the checklist set.

f1    f2    f3    f4    f5 ----------------------------- m1 | w-cp  w-cp  w-cp | m2 | f-cp  f-cp  f-cp  w-cp | m3 | f-cp                    w-cp

\begin{center}
\textbf{Table 1: Pair State Example}
\end{center}
...
\subsubsection{Scheduling Checks}

\paragraph{Triggered-Check Queue}
...
\paragraph{Performing Connectivity Checks}
...
\section{If the triggered-check queue associated with the checklist}

contains one or more candidate pairs, the agent removes the top pair from the queue, performs a connectivity check on that pair, puts the candidate pair state to In-Progress, and aborts the subsequent steps.

\section{If there is no candidate pair in the Waiting state, and if there}

are one or more pairs in the Frozen state, the agent checks the foundation associated with each pair in the Frozen state.  For a given foundation, if there is no pair (in any checklist in the checklist set) in the Waiting or In-Progress state, the agent puts the candidate pair state to Waiting and continues with the next step.

\section{If there are one or more candidate pairs in the Waiting state,}

the agent picks the highest-priority candidate pair (if there are multiple pairs with the same priority, the pair with the lowest component ID is picked) in the Waiting state, performs a connectivity check on that pair, puts the candidate pair state to In-Progress, and aborts the subsequent steps.

\section{If this step is reached, no check could be performed for the}

checklist that was picked.  So, without waiting for timer Ta to expire again, select the next checklist in the Running state and return to step \#1.  If this happens for every single checklist in the Running state, meaning there are no remaining candidate pairs to perform connectivity checks for, abort these steps.
...
\section{Performing Connectivity Checks}
...
\subsubsection{ICE-CONTROLLED and ICE-CONTROLLING}
...
\subsection{STUN Client Procedures}

\subsubsection{Creating Permissions for Relayed Candidates}
...
\subsubsection{Forming Credentials}
...
\subsubsection{Diffserv Treatment}
...
\subsubsection{Processing the Response}
...
\begin{itemize}
\item The Binding request generated a success response; and
\item The source and destination transport addresses in the Binding request and response are symmetric.
...
\begin{itemize}
\item The type is peer reflexive.
\item The base is the local candidate of the candidate pair from which the Binding request was sent.
\item The priority is the value of the PRIORITY attribute in the Binding request.
\item The foundation is described in Section 5.1.1.3.
...
\section{If the valid pair equals the pair that generated the check, the}

pair is added to the valid list associated with the checklist to which the pair belongs; or

\section{If the valid pair equals another pair in a checklist, that pair}

is added to the valid list associated with the checklist of that pair.  The pair that generated the check is not added to a valid list; or

\section{If the valid pair is not in any checklist, the agent computes the}
...
\paragraph{Checklist State Updates}
...
\subsection{STUN Server Procedures}
...
\subsubsection{Additional Procedures for Full Implementations}
...
\paragraph{Detecting and Repairing Role Conflicts}
...
\begin{itemize}
\item If the agent is in the controlling role, and the ICE-CONTROLLING attribute is present in the request:
...
\item If the agent is in the controlled role, and the ICE-CONTROLLED attribute is present in the request:
...
\item If the agent is in the controlled role and the ICE-CONTROLLING attribute was present in the request, or if the agent was in the controlling role and the ICE-CONTROLLED attribute was present in the request, there is no conflict.
...
\end{itemize}
\paragraph{Computing Mapped Addresses}
...
\paragraph{Learning Peer-Reflexive Candidates}
...
\item The type is peer reflexive.
\item The priority is the value of the PRIORITY attribute in the Binding request.
\item The foundation is an arbitrary value, different from the foundations of all other remote candidates.  If any subsequent candidate exchanges contain this peer-reflexive candidate, it will signal the actual foundation for the candidate.
\item The component ID is the component ID of the local candidate to which the request was sent.
...
\begin{itemize}
\item When the pair is already on the checklist:
...
\item If the pair is not already on the checklist:
...
\end{itemize}
\paragraph{Updating the Nominated Flag}
...
\begin{itemize}
\item If the state of this pair is Succeeded, it means that the check previously sent by this pair produced a successful response and generated a valid pair (Section 7.2.5.3.2).  The agent sets the nominated flag value of the valid pair to true.
\item If the received Binding request triggered a new check to be enqueued in the triggered-check queue (Section 7.3.1.4), once the check is sent and if it generates a successful response, and generates a valid pair, the agent sets the nominated flag of the pair to true.  If the request fails (Section 7.2.5.2), the agent MUST remove the candidate pair from the valid list, set the candidate pair state to Failed, and set the checklist state to Failed.
...
\end{itemize}
\subsubsection{Additional Procedures for Lite Implementations}
...
\subsubsection{Updating Checklist and ICE States}
...
\begin{itemize}
\item Once a candidate pair for a component of a data stream has been nominated, and the state of the checklist associated with the data stream is Running, the ICE agent MUST remove all candidate pairs for the same component from the checklist and from the triggered- check queue.  If the state of a pair is In-Progress, the agent cancels the In-Progress transaction.  Cancellation means that the agent will not retransmit the Binding requests associated with the connectivity-check transaction, will not treat the lack of response to be a failure, but will wait the duration of the transaction timeout for a response.
\item Once candidate pairs for each component of a data stream have been nominated, and the state of the checklist associated with the data stream is Running, the ICE agent sets the state of the checklist to Completed.
\item Once a candidate pair for a component of a data stream has been nominated, an agent MUST continue to respond to any Binding request it might still receive for the nominated pair and for any remaining candidate pairs in the checklist associated with the
...
\end{itemize}
\subsection{Procedures for Lite Implementations}
...
\subsection{Freeing Candidates}

\subsubsection{Full Implementation Procedures}
...
\subsubsection{Lite Implementation Procedures}
...
\begin{itemize}
\item Change the destinations of data streams.
\item Change from a lite implementation to a full implementation.
\item Change from a full implementation to a lite implementation.
...
\begin{itemize}
\item empty if the state of the checklist for that data stream is Running, and there is no previous selected pair for that component due to an ICE restart
\item equal to the previous selected pair for a component of a data stream if the state of the checklist for that data stream is Running, and there was a previous selected pair for that component due to an ICE restart
...
\end{itemize}
\subsubsection{Procedures for Lite Implementations}
...
\subsection{Example with IPv4 Addresses}
...
\begin{center}
\textbf{Figure 7: Example Topology}
\end{center}
...
L             NAT           STUN             R |STUN alloc.   |              |              | |(1) STUN Req  |              |              | |S=\$L-PRIV-1   |              |              | |D=\$STUN-PUB-1 |              |              | |------------->|              |              |

\begin{quote}
\textit{Note: |(2) STUN Req  |              | |S=\$NAT-PUB-1  |              | |D=\$STUN-PUB-1 |              | |------------->|              | |(3) STUN Res  |              | |S=\$STUN-PUB-1 |              | |D=\$NAT-PUB-1  |              | |MA=\$NAT-PUB-1 |              | |<-------------|              |}
\end{quote}

|(4) STUN Res  |              |              | |S=\$STUN-PUB-1 |              |              | |D=\$L-PRIV-1   |              |              | |MA=\$NAT-PUB-1 |              |              | |<-------------|              |              | |(5) L's Candidate Information|              | |------------------------------------------->|

\begin{quote}
\textit{Note: |              |              | STUN |              |              | alloc. |              |(6) STUN Req  | |              |S=\$R-PUB-1    | |              |D=\$STUN-PUB-1 | |              |<-------------| |              |(7) STUN Res  | |              |S=\$STUN-PUB-1 | |              |D=\$R-PUB-1    | |              |MA=\$R-PUB-1   | |              |------------->|}
\end{quote}

|(8) R's Candidate Information|              | |<-------------------------------------------|

\begin{quote}
\textit{Note: |         (9) Bind Req        |Begin |         S=\$R-PUB-1          |Connectivity |         D=\$L-PRIV-1         |Checks |         <-------------------| |         Dropped             |}
\end{quote}

|(10) Bind Req |              |              | |S=\$L-PRIV-1   |              |              | |D=\$R-PUB-1    |              |              | |------------->|              |              |

\begin{quote}
\textit{Note: |(11) Bind Req |              | |S=\$NAT-PUB-1  |              | |D=\$R-PUB-1    |              | |---------------------------->| |(12) Bind Res |              | |S=\$R-PUB-1    |              | |D=\$NAT-PUB-1  |              | |MA=\$NAT-PUB-1 |              | |<----------------------------|}
\end{quote}

|(13) Bind Res |              |              | |S=\$R-PUB-1    |              |              | |D=\$L-PRIV-1   |              |              | |MA=\$NAT-PUB-1 |              |              | |<-------------|              |              | |Data          |              |              | |===========================================>|

\begin{quote}
\textit{Note: |              |              | |(14) Bind Req |              | |S=\$R-PUB-1    |              | |D=\$NAT-PUB-1  |              | |<----------------------------|}
\end{quote}

|(15) Bind Req |              |              | |S=\$R-PUB-1    |              |              | |D=\$L-PRIV-1   |              |              | |<-------------|              |              | |(16) Bind Res |              |              | |S=\$L-PRIV-1   |              |              | |D=\$R-PUB-1    |              |              | |MA=\$R-PUB-1   |              |              | |------------->|              |              |

\begin{quote}
\textit{Note: |(17) Bind Res |              | |S=\$NAT-PUB-1  |              | |D=\$R-PUB-1    |              | |MA=\$R-PUB-1   |              | |---------------------------->|}
\end{quote}
...
|(18) Bind Req |              |              | |S=\$L-PRIV-1   |              |              | |D=\$R-PUB-1    |              |              | |USE-CAND      |              |              | |------------->|              |              |

\begin{quote}
\textit{Note: |(19) Bind Req |              | |S=\$NAT-PUB-1  |              | |D=\$R-PUB-1    |              | |USE-CAND      |              | |---------------------------->| |(20) Bind Res |              | |S=\$R-PUB-1    |              | |D=\$NAT-PUB-1  |              | |MA=\$NAT-PUB-1 |              | |<----------------------------|}
\end{quote}

|(21) Bind Res |              |              | |S=\$R-PUB-1    |              |              | |D=\$L-PRIV-1   |              |              | |MA=\$NAT-PUB-1 |              |              | |<-------------|              |              |
...
Pairs ENTITY                   Local         Remote     Pair \#     Valid ------------------------------------------------------------------ ICE Agent L:             L\_PRIV\_1      R\_PUB\_1       L1

ICE Agent R:             R\_PUB\_1       L\_PRIV\_1      R1 R\_PUB\_1       NAT\_PUB\_1     R2
...
Pairs ENTITY                   Local         Remote     Pair \#     Valid ------------------------------------------------------------------ ICE Agent L:             L\_PRIV\_1      R\_PUB\_1       L1 NAT\_PUB\_1     R\_PUB\_1       L2        X
...
ICE Agent R:             R\_PUB\_1       L\_PRIV\_1      R1 R\_PUB\_1       NAT\_PUB\_1     R2        X
...
\subsection{Example with IPv6 Addresses}
...
\begin{center}
\textbf{Figure 9: Example Topology}
\end{center}
...
L                           STUN             R |STUN alloc.                  |              | |(1) STUN Req                 |              | |S=\$L-PUB-1                   |              | |D=\$STUN-PUB-1                |              |
...
Pairs ENTITY                   Local         Remote     Pair \#     Valid ------------------------------------------------------------------ ICE Agent L:             L\_PUB\_1       R\_PUB\_1       L1
...
Pairs ENTITY                   Local         Remote     Pair \#     Valid ------------------------------------------------------------------ ICE Agent L:             L\_PUB\_1       R\_PUB\_1       L1         X
...
\subsection{New Error-Response Codes}
...
\subsection{NAT and Firewall Types}
...
\subsubsection{STUN and TURN Server-Capacity Planning}
...
\subsubsection{Gathering and Connectivity Checks}
...
\subsection{Troubleshooting and Performance Management}
...
\subsection{Endpoint Configuration}
...
\subsection{Brittleness Introduced by ICE}
...
\subsection{Requirements for a Long-Term Solution}
...
\subsection{Issues with Existing NAPT Boxes}
...
\subsection{Attacks on Connectivity Checks}
...
\subsection{Attacks on Server-Reflexive Address Gathering}
...
\begin{itemize}
\item An attacker can compromise the DNS, causing DNS queries to return a rogue STUN server address.  That server can provide the client with fake server-reflexive candidates.  This attack is mitigated by DNS security, though DNSSEC is not required to address it.
\item An attacker that can observe STUN messages (such as an attacker on a shared network segment, like Wi-Fi) can inject a fake response that is valid and will be accepted by the client.
\item An attacker can compromise a STUN server and cause it to send responses with incorrect mapped addresses.
...
\end{itemize}
\subsection{Attacks on Relayed Candidate Gathering}
...
\subsubsection{STUN Amplification Attack}
...
\begin{itemize}
\item There was no response because the initiator is being used to launch a DoS attack against an unsuspecting target that will not respond.
\item There was no response because the IP address and port are not reachable by the initiator.
...
\subsection{STUN Error Responses}
...
\section{Changes from RFC 5245}

The purpose of this updated ICE specification is to:

\begin{itemize}
\item Clarify procedures in RFC 5245.
\item Make technical changes, due to discovered flaws in RFC 5245 and feedback from the community that has implemented and deployed ICE applications based on RFC 5245.
\item Make the procedures independent of the signaling protocol, by removing the SIP and SDP procedures.  Procedures specific to a signaling protocol will be defined in separate usage documents. [ICE-SIP-SDP] defines ICE usage with SIP and SDP.
The following technical changes have been done:

\item Aggressive nomination removed.
\item The procedures for calculating candidate pair states and scheduling connectivity checks modified.
\item Procedures for calculation of Ta and RTO modified.
\item Active checklist and Frozen checklist definitions removed.
\item 'ice2' ICE option added.
\item IPv6 considerations modified.
\item Usage with no-op for keepalives, and keepalives with non-ICE peers, removed.
\end{itemize}
\section{References}
...
[RFC4941]  Narten, T., Draves, R., and S. Krishnan, "Privacy Extensions for Stateless Address Autoconfiguration in IPv6", RFC 4941, DOI 10.17487/RFC4941, September 2007, <\url{https://www.rfc-editor.org/info/rfc4941>.}

[RFC5389]  Rosenberg, J., Mahy, R., Matthews, P., and D. Wing, "Session Traversal Utilities for NAT (STUN)", RFC 5389, DOI 10.17487/RFC5389, October 2008, <\url{https://www.rfc-editor.org/info/rfc5389>.}

[RFC5766]  Mahy, R., Matthews, P., and J. Rosenberg, "Traversal Using Relays around NAT (TURN): Relay Extensions to Session Traversal Utilities for NAT (STUN)", RFC 5766, DOI 10.17487/RFC5766, April 2010, <\url{https://www.rfc-editor.org/info/rfc5766>.}

[RFC6336]  Westerlund, M. and C. Perkins, "IANA Registry for Interactive Connectivity Establishment (ICE) Options", RFC 6336, DOI 10.17487/RFC6336, July 2011, <\url{https://www.rfc-editor.org/info/rfc6336>.}

[RFC6724]  Thaler, D., Ed., Draves, R., Matsumoto, A., and T. Chown, "Default Address Selection for Internet Protocol Version 6 (IPv6)", RFC 6724, DOI 10.17487/RFC6724, September 2012, <\url{https://www.rfc-editor.org/info/rfc6724>.}
...
[RFC1918]  Rekhter, Y., Moskowitz, B., Karrenberg, D., de Groot, G., and E. Lear, "Address Allocation for Private Internets", BCP 5, RFC 1918, DOI 10.17487/RFC1918, February 1996, <\url{https://www.rfc-editor.org/info/rfc1918>.}

[RFC2475]  Blake, S., Black, D., Carlson, M., Davies, E., Wang, Z., and W. Weiss, "An Architecture for Differentiated Services", RFC 2475, DOI 10.17487/RFC2475, December 1998, <\url{https://www.rfc-editor.org/info/rfc2475>.}

[RFC3102]  Borella, M., Lo, J., Grabelsky, D., and G. Montenegro, "Realm Specific IP: Framework", RFC 3102, DOI 10.17487/RFC3102, October 2001, <\url{https://www.rfc-editor.org/info/rfc3102>.}

[RFC3103]  Borella, M., Grabelsky, D., Lo, J., and K. Taniguchi, "Realm Specific IP: Protocol Specification", RFC 3103, DOI 10.17487/RFC3103, October 2001, <\url{https://www.rfc-editor.org/info/rfc3103>.}

[RFC3235]  Senie, D., "Network Address Translator (NAT)-Friendly Application Design Guidelines", RFC 3235, DOI 10.17487/RFC3235, January 2002, <\url{https://www.rfc-editor.org/info/rfc3235>.}

[RFC3261]  Rosenberg, J., Schulzrinne, H., Camarillo, G., Johnston, A., Peterson, J., Sparks, R., Handley, M., and E. Schooler, "SIP: Session Initiation Protocol", RFC 3261, DOI 10.17487/RFC3261, June 2002, <\url{https://www.rfc-editor.org/info/rfc3261>.}

[RFC3264]  Rosenberg, J. and H. Schulzrinne, "An Offer/Answer Model with Session Description Protocol (SDP)", RFC 3264, DOI 10.17487/RFC3264, June 2002, <\url{https://www.rfc-editor.org/info/rfc3264>.}

[RFC3303]  Srisuresh, P., Kuthan, J., Rosenberg, J., Molitor, A., and A. Rayhan, "Middlebox communication architecture and framework", RFC 3303, DOI 10.17487/RFC3303, August 2002, <\url{https://www.rfc-editor.org/info/rfc3303>.}

[RFC3424]  Daigle, L., Ed. and IAB, "IAB Considerations for UNilateral Self-Address Fixing (UNSAF) Across Network Address Translation", RFC 3424, DOI 10.17487/RFC3424, November 2002, <\url{https://www.rfc-editor.org/info/rfc3424>.}

[RFC3489]  Rosenberg, J., Weinberger, J., Huitema, C., and R. Mahy, "STUN - Simple Traversal of User Datagram Protocol (UDP) Through Network Address Translators (NATs)", RFC 3489, DOI 10.17487/RFC3489, March 2003, <\url{https://www.rfc-editor.org/info/rfc3489>.}

[RFC3550]  Schulzrinne, H., Casner, S., Frederick, R., and V. Jacobson, "RTP: A Transport Protocol for Real-Time Applications", STD 64, RFC 3550, DOI 10.17487/RFC3550, July 2003, <\url{https://www.rfc-editor.org/info/rfc3550>.}

[RFC3605]  Huitema, C., "Real Time Control Protocol (RTCP) attribute in Session Description Protocol (SDP)", RFC 3605, DOI 10.17487/RFC3605, October 2003, <\url{https://www.rfc-editor.org/info/rfc3605>.}

[RFC3711]  Baugher, M., McGrew, D., Naslund, M., Carrara, E., and K. Norrman, "The Secure Real-time Transport Protocol (SRTP)", RFC 3711, DOI 10.17487/RFC3711, March 2004, <\url{https://www.rfc-editor.org/info/rfc3711>.}

[RFC3725]  Rosenberg, J., Peterson, J., Schulzrinne, H., and G. Camarillo, "Best Current Practices for Third Party Call Control (3pcc) in the Session Initiation Protocol (SIP)", BCP 85, RFC 3725, DOI 10.17487/RFC3725, April 2004, <\url{https://www.rfc-editor.org/info/rfc3725>.}

[RFC3879]  Huitema, C. and B. Carpenter, "Deprecating Site Local Addresses", RFC 3879, DOI 10.17487/RFC3879, September 2004, <\url{https://www.rfc-editor.org/info/rfc3879>.}

[RFC4038]  Shin, M-K., Ed., Hong, Y-G., Hagino, J., Savola, P., and E. Castro, "Application Aspects of IPv6 Transition", RFC 4038, DOI 10.17487/RFC4038, March 2005, <\url{https://www.rfc-editor.org/info/rfc4038>.}

[RFC4091]  Camarillo, G. and J. Rosenberg, "The Alternative Network Address Types (ANAT) Semantics for the Session Description Protocol (SDP) Grouping Framework", RFC 4091, DOI 10.17487/RFC4091, June 2005, <\url{https://www.rfc-editor.org/info/rfc4091>.}

[RFC4092]  Camarillo, G. and J. Rosenberg, "Usage of the Session Description Protocol (SDP) Alternative Network Address Types (ANAT) Semantics in the Session Initiation Protocol (SIP)", RFC 4092, DOI 10.17487/RFC4092, June 2005, <\url{https://www.rfc-editor.org/info/rfc4092>.}

[RFC4103]  Hellstrom, G. and P. Jones, "RTP Payload for Text Conversation", RFC 4103, DOI 10.17487/RFC4103, June 2005, <\url{https://www.rfc-editor.org/info/rfc4103>.}
...
[RFC4566]  Handley, M., Jacobson, V., and C. Perkins, "SDP: Session Description Protocol", RFC 4566, DOI 10.17487/RFC4566, July 2006, <\url{https://www.rfc-editor.org/info/rfc4566>.}
...
[RFC5245]  Rosenberg, J., "Interactive Connectivity Establishment (ICE): A Protocol for Network Address Translator (NAT) Traversal for Offer/Answer Protocols", RFC 5245, DOI 10.17487/RFC5245, April 2010, <\url{https://www.rfc-editor.org/info/rfc5245>.}

[RFC5382]  Guha, S., Ed., Biswas, K., Ford, B., Sivakumar, S., and P. Srisuresh, "NAT Behavioral Requirements for TCP", BCP 142, RFC 5382, DOI 10.17487/RFC5382, October 2008, <\url{https://www.rfc-editor.org/info/rfc5382>.}

[RFC5761]  Perkins, C. and M. Westerlund, "Multiplexing RTP Data and Control Packets on a Single Port", RFC 5761, DOI 10.17487/RFC5761, April 2010, <\url{https://www.rfc-editor.org/info/rfc5761>.}

[RFC6080]  Petrie, D. and S. Channabasappa, Ed., "A Framework for Session Initiation Protocol User Agent Profile Delivery", RFC 6080, DOI 10.17487/RFC6080, March 2011, <\url{https://www.rfc-editor.org/info/rfc6080>.}

[RFC6146]  Bagnulo, M., Matthews, P., and I. van Beijnum, "Stateful NAT64: Network Address and Protocol Translation from IPv6 Clients to IPv4 Servers", RFC 6146, DOI 10.17487/RFC6146, April 2011, <\url{https://www.rfc-editor.org/info/rfc6146>.}

[RFC6147]  Bagnulo, M., Sullivan, A., Matthews, P., and I. van Beijnum, "DNS64: DNS Extensions for Network Address Translation from IPv6 Clients to IPv4 Servers", RFC 6147, DOI 10.17487/RFC6147, April 2011, <\url{https://www.rfc-editor.org/info/rfc6147>.}

[RFC6298]  Paxson, V., Allman, M., Chu, J., and M. Sargent, "Computing TCP's Retransmission Timer", RFC 6298, DOI 10.17487/RFC6298, June 2011, <\url{https://www.rfc-editor.org/info/rfc6298>.}

[RFC6544]  Rosenberg, J., Keranen, A., Lowekamp, B., and A. Roach, "TCP Candidates with Interactive Connectivity Establishment (ICE)", RFC 6544, DOI 10.17487/RFC6544, March 2012, <\url{https://www.rfc-editor.org/info/rfc6544>.}

[RFC6928]  Chu, J., Dukkipati, N., Cheng, Y., and M. Mathis, "Increasing TCP's Initial Window", RFC 6928, DOI 10.17487/RFC6928, April 2013, <\url{https://www.rfc-editor.org/info/rfc6928>.}

[RFC7050]  Savolainen, T., Korhonen, J., and D. Wing, "Discovery of the IPv6 Prefix Used for IPv6 Address Synthesis", RFC 7050, DOI 10.17487/RFC7050, November 2013, <\url{https://www.rfc-editor.org/info/rfc7050>.}

[RFC7721]  Cooper, A., Gont, F., and D. Thaler, "Security and Privacy Considerations for IPv6 Address Generation Mechanisms", RFC 7721, DOI 10.17487/RFC7721, March 2016, <\url{https://www.rfc-editor.org/info/rfc7721>.}

[RFC7825]  Goldberg, J., Westerlund, M., and T. Zeng, "A Network Address Translator (NAT) Traversal Mechanism for Media Controlled by the Real-Time Streaming Protocol (RTSP)", RFC 7825, DOI 10.17487/RFC7825, December 2016, <\url{https://www.rfc-editor.org/info/rfc7825>.}

[RFC8421]  Martinsen, P., Reddy, T., and P. Patil, "Interactive Connectivity Establishment (ICE) Multihomed and IPv4/IPv6 Dual-Stack Guidelines", RFC 8421, DOI 10.17487/RFC8421, July 2018, <\url{https://www.rfc-editor.org/info/rfc8421>.}
...
\section{Lite and Full Implementations}
...
\subsection{Pacing of STUN Transactions}
...
\begin{itemize}
\item Start with the following rules that would be generally applicable to transport protocols:
\end{itemize}
\section{Let MaxBytes be the maximum number of bytes allowed to be}

outstanding in the network at startup, which SHOULD be 14600, as defined in Section~2 of [RFC6928].

\section{Let HTO be the transaction timeout, which SHOULD be 2*RTT if}

RTT is known or 500 ms otherwise.  This is based on the RTO for STUN messages from [RFC5389] and the TCP initial RTO, which is 1 sec in [RFC6298].

\section{Let MinPacing be the minimum pacing interval between}

transactions, which is 5 ms (see above).

\begin{itemize}
\item Observe that agents typically do not know the RTT for ICE transactions (connectivity checks in particular), meaning that HTO will almost always be 500 ms.
\item Observe that a MinPacing of 5 ms and HTO of 500 ms gives at most 100 packets/HTO, which for a typical ICE check of less than 120 bytes means a maximum of 12000 outstanding bytes in the network, which is less than the maximum expressed by rule 1.
\item Thus, for ICE, the rule set reduces to just the MinPacing rule, which is equivalent to having a global Ta value.
\end{itemize}
\subsection{Candidates with Multiple Bases}
...
\textbackslash{}\textbackslash{}     // ----- | | |192.168.1.100      ----- +----------+           //     \textbackslash{}\textbackslash{}             +----------+

\begin{quote}
\textit{Note: |          |         |            |          | Initiator|---------|  C:net10  |-----------| Responder| |10.0.1.100|         | 10.0.1.101 |          |}
\end{quote}

+----------+           \textbackslash{}\textbackslash{}     //             +----------+ -----

\begin{center}
\textbf{Figure 11: Identical Candidates with Different Bases}
\end{center}
...
\subsection{Purpose of the Related-Address and Related-Port Attributes}
...
\subsection{Importance of the STUN Username}
...
\subsection{The Candidate Pair Priority Formula}
...
\subsection{Why Are Keepalives Needed?}
...
\subsection{Why Prefer Peer-Reflexive Candidates?}
...
\subsection{Why Are Binding Indications Used for Keepalives?}
...
\subsection{Selecting Candidate Type Preference}
...
\section{Connectivity-Check Bandwidth}
...
\begin{center}
\textbf{Figure 12: Connectivity-Check Bandwidth}
\end{center}
...
Email: jdrosen@jdrosen.net URI:   \url{http://www.jdrosen.net}
